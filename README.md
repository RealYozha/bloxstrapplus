> [!CAUTION]
> The only official places to download Bloxstrap are the GitHub repository [Bloxstrap](https://github.com/bloxstraplabs/bloxstrap) and [bloxstraplabs.com](https://bloxstraplabs.com). Any other websites offering downloads or claiming to be us are not controlled by us.
> The only official place to download Bloxstrap+ is this GitHub repository.
